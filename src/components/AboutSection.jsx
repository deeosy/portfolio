  ...
  return (
    <div className='max-w-7xl h-full overflow-y-scroll mx-auto px-8 no-scrollbar '>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center  md:px-10">
        ...
        <div className="bg-gray-800 bg-opacity-50 backdrop-blur rounded-2xl p-8 w-full h-full md:max-w-fit border border-gray-700 place-self-start md:place-self-end">
